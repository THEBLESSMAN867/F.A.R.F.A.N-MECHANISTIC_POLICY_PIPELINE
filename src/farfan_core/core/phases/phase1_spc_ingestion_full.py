...
from farfan_core.processing.cpp_ingestion.models import CanonPolicyPackage, ChunkGraph, PolicyManifest, QualityMetrics, IntegrityIndex
from farfan_core.core.phases.phase1_models import (
...
class Phase1SPCIngestionFullContract:
    ...
    def _construct_cpp_with_verification(self, ranked: List[SmartChunk]) -> CanonPolicyPackage:
        ...
        from farfan_core.processing.cpp_ingestion.models import Chunk as LegacyChunk, ChunkResolution, TextSpan
