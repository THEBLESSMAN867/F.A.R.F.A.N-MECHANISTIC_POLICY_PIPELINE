...
class ReconciliationValidator:
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_range")
    def validate_range(self, value: float, rule: ValidationRule) -> ValidationResult:
        ...
        if rule.expected_range is None:
            return ValidationResult(
                ...
                expected_value=None, violation_severity=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_range").get("auto_param_L115_56", 0.0), penalty_applied=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_range").get("auto_param_L115_77", 0.0)
            )
        ...
        if not passed:
            ...
            if value < min_val:
                violation_severity = min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_range").get("auto_param_L124_41", 1.0), (min_val - value) / max(abs(min_val), get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_range").get("auto_param_L124_84", 1.0)))
            else:
                violation_severity = min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_range").get("auto_param_L126_41", 1.0), (value - max_val) / max(abs(max_val), get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_range").get("auto_param_L126_84", 1.0)))
        else:
            violation_severity = get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_range").get("violation_severity", 0.0) # Refactored

        penalty = violation_severity * rule.penalty_factor if not passed else get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_range").get("auto_param_L130_78", 0.0)
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_unit")
    def validate_unit(self, unit: str, rule: ValidationRule) -> ValidationResult:
        ...
        if rule.expected_unit is None:
            return ValidationResult(
                ...
                expected_value=None, violation_severity=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_unit").get("auto_param_L144_56", 0.0), penalty_applied=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_unit").get("auto_param_L144_77", 0.0)
            )

        passed = unit.lower() == rule.expected_unit.lower()
        violation_severity = get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_unit").get("auto_param_L148_29", 1.0) if not passed else get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_unit").get("auto_param_L148_52", 0.0)
        penalty = violation_severity * rule.penalty_factor if not passed else get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_unit").get("auto_param_L149_78", 0.0)
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_period")
    def validate_period(self, period: str, rule: ValidationRule) -> ValidationResult:
        ...
        if rule.expected_period is None:
            return ValidationResult(
                ...
                expected_value=None, violation_severity=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_period").get("auto_param_L163_56", 0.0), penalty_applied=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_period").get("auto_param_L163_77", 0.0)
            )

        passed = period.lower() == rule.expected_period.lower()
        violation_severity = get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_period").get("auto_param_L167_29", 1.0) if not passed else get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_period").get("auto_param_L167_52", 0.0)
        penalty = violation_severity * rule.penalty_factor if not passed else get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_period").get("auto_param_L168_78", 0.0)
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_entity")
    def validate_entity(self, entity: str, rule: ValidationRule) -> ValidationResult:
        ...
        if rule.expected_entity is None:
            return ValidationResult(
                ...
                expected_value=None, violation_severity=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_entity").get("auto_param_L182_56", 0.0), penalty_applied=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_entity").get("auto_param_L182_77", 0.0)
            )

        passed = entity.lower() == rule.expected_entity.lower()
        violation_severity = get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_entity").get("auto_param_L186_29", 1.0) if not passed else get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_entity").get("auto_param_L186_52", 0.0)
        penalty = violation_severity * rule.penalty_factor if not passed else get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_entity").get("auto_param_L187_78", 0.0)
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.validate_data")
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.ReconciliationValidator.calculate_total_penalty")
...
class ProbativeTest:
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.ProbativeTest.calculate_likelihood_ratio")
    def calculate_likelihood_ratio(self, test_passed: bool) -> float:
        ...
        Hoop test: strong disconfirmation if fails (LR ~ get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ProbativeTest.calculate_likelihood_ratio").get("auto_param_L244_57", 0.1) if fails)
        Smoking gun: strong confirmation if passes (LR ~ 10)
        Doubly decisive: both necessary and sufficient (LR ~ 20 if passes, get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ProbativeTest.calculate_likelihood_ratio").get("auto_param_L246_75", 0.05) if fails)
        """
        if self.test_type == ProbativeTestType.STRAW_IN_WIND:
            return 2.0 if test_passed else get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ProbativeTest.calculate_likelihood_ratio").get("auto_param_L249_43", 0.8)
...
class BayesianUpdater:
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianUpdater.update")
    def update(self, prior: float, test: ProbativeTest, test_passed: bool) -> float:
        ...
        posterior = max(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianUpdater.update").get("auto_param_L302_24", 0.0), min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianUpdater.update").get("auto_param_L302_33", 1.0), posterior))
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianUpdater._calculate_evidence_weight")
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianUpdater.export_to_csv")
...
class DispersionEngine:
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_cv")
    def calculate_cv(self, scores: list[float]) -> float:
        """Calculate Coefficient of Variation (CV = std / mean)"""
        if not scores or len(scores) < 2:
            return get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_cv").get("auto_param_L413_19", 0.0)

        mean_score = np.mean(scores)
        std_score = np.std(scores, ddof=1)

        if mean_score == 0:
            return get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_cv").get("auto_param_L419_19", 0.0)

        cv = std_score / mean_score
        return cv

    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_max_gap")
    def calculate_max_gap(self, scores: list[float]) -> float:
        """Calculate maximum gap between adjacent scores"""
        if not scores or len(scores) < 2:
            return get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_max_gap").get("auto_param_L428_19", 0.0)

        sorted_scores = sorted(scores)
        gaps = [sorted_scores[i+1] - sorted_scores[i] for i in range(len(sorted_scores) - 1)]

        return max(gaps) if gaps else get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_max_gap").get("auto_param_L433_38", 0.0)

    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_gini")
    def calculate_gini(self, scores: list[float]) -> float:
        ...
        """
        if not scores or len(scores) < 2:
            return get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_gini").get("auto_param_L442_19", 0.0)
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty")
    def calculate_dispersion_penalty(self, scores: list[float]) -> tuple[float, dict[str, float]]:
        ...
        cv_penalty = max(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty").get("auto_param_L465_25", 0.0), (cv - self.dispersion_threshold) * get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty").get("auto_param_L465_65", 0.5))
        gap_penalty = max(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty").get("auto_param_L466_26", 0.0), (max_gap - get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty").get("auto_param_L466_42", 1.0)) * get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty").get("auto_param_L466_49", 0.3))  # Penalty if gap > get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty").get("auto_param_L466_74", 1.0)
        gini_penalty = max(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty").get("auto_param_L467_27", 0.0), (gini - get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty").get("auto_param_L467_40", 0.3)) * get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty").get("auto_param_L467_47", 0.4))  # Penalty if Gini > get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty").get("auto_param_L467_73", 0.3)

        # Total penalty (capped at get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty").get("auto_param_L469_35", 1.0))
        total_penalty = min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.DispersionEngine.calculate_dispersion_penalty").get("auto_param_L470_28", 1.0), cv_penalty + gap_penalty + gini_penalty)
...
class PeerCalibrator:
    ...
    def compare_to_peers(
        ...
        peer_scores = [
            peer.scores.get(dimension, get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L531_39", 0.0))
        ...
        if not peer_scores:
            return PeerComparison(
                ...
                peer_mean=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L539_26", 0.0),
                peer_std=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L540_25", 0.0),
                z_score=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L541_24", 0.0),
                percentile=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L542_27", 0.5),
                deviation_penalty=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L543_34", 0.0),
                narrative="No peer data available for comparison"
            )

        # Calculate peer statistics
        peer_mean = np.mean(peer_scores)
        peer_std = np.std(peer_scores, ddof=1) if len(peer_scores) > 1 else get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L549_76", 1.0)

        # Calculate z-score
        z_score = (target_score - peer_mean) / (peer_std + 1e-10)

        # Calculate percentile
        percentile = stats.percentileofscore(peer_scores, target_score) / 10get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L555_76", 0.0)

        # Calculate deviation penalty
        deviation_penalty = max(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L558_32", 0.0), (abs(z_score) - self.deviation_threshold) * get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L558_81", 0.2))
        deviation_penalty = min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L559_32", 0.5), deviation_penalty)  # Cap at get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L559_66", 0.5)
    ...
    def _generate_narrative(
        ...
        elif z_score > get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L588_23", 0.5):
            performance = "moderately above"
        elif z_score > -get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L590_24", 0.5):
        ...
        if percentile >= get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L598_25", 0.9):
            rank = "top 10%"
        elif percentile >= get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L600_27", 0.75):
            rank = "top quartile"
        elif percentile >= get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L602_27", 0.5):
            rank = "above median"
        elif percentile >= get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.PeerCalibrator.__init__").get("auto_param_L604_27", 0.25):
            rank = "below median"
        else:
...
class BayesianRollUp:
    ...
    def aggregate_micro_to_meso(
        ...
        dispersion_penalty: float = get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianRollUp.__init__").get("auto_param_L647_36", 0.0),
        peer_penalty: float = get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianRollUp.__init__").get("auto_param_L648_30", 0.0),
        ...
        if not micro_analyses:
            return get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianRollUp.__init__").get("auto_param_L659_19", 0.0)
        ...
        adjusted_posterior = max(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianRollUp.__init__").get("auto_param_L675_33", 0.0), min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianRollUp.__init__").get("auto_param_L675_42", 1.0), adjusted_posterior))
    ...
    def export_to_csv(
        ...
        for analysis in meso_analyses:
            rows.append([
                ...
                f"{analysis.dispersion_metrics.get('cv', get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianRollUp.__init__").get("auto_param_L709_57", 0.0)):.4f}",
                f"{analysis.dispersion_metrics.get('max_gap', get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianRollUp.__init__").get("auto_param_L710_62", 0.0)):.4f}",
                f"{analysis.dispersion_metrics.get('gini', get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianRollUp.__init__").get("auto_param_L711_59", 0.0)):.4f}"
            ])
...
class ContradictionDetection:
    ...
    score_b: float
    discrepancy: float
    severity: float  # get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianRollUp.__init__").get("auto_param_L732_23", 0.0)-get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianRollUp.__init__").get("auto_param_L732_27", 1.0)
    description: str
...
class ContradictionScanner:
    ...
    def scan_micro_meso(
        ...
        for micro in micro_analyses:
            ...
            if discrepancy > self.discrepancy_threshold:
                severity = min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ContradictionScanner.__init__").get("auto_param_L757_31", 1.0), discrepancy / 2.0)
    ...
    def scan_meso_macro(
        ...
        for meso in meso_analyses:
            ...
            if discrepancy > self.discrepancy_threshold:
                severity = min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ContradictionScanner.__init__").get("auto_param_L789_31", 1.0), discrepancy / 2.0)
    ...
    @calibrated_method("farfan_pipeline.analysis.bayesian_multilevel_system.ContradictionScanner.calculate_contradiction_penalty")
    def calculate_contradiction_penalty(self) -> float:
        """Calculate penalty based on detected contradictions"""
        if not self.contradictions:
            return get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ContradictionScanner.calculate_contradiction_penalty").get("auto_param_L812_19", 0.0)

        # Average severity weighted by number of contradictions
        avg_severity = np.mean([c.severity for c in self.contradictions])
        count_factor = min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ContradictionScanner.calculate_contradiction_penalty").get("auto_param_L816_27", 1.0), len(self.contradictions) / 1get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ContradictionScanner.calculate_contradiction_penalty").get("auto_param_L816_60", 0.0))  # Max at 10 contradictions

        penalty = avg_severity * count_factor * get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ContradictionScanner.calculate_contradiction_penalty").get("auto_param_L818_48", 0.5)  # Max penalty get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.ContradictionScanner.calculate_contradiction_penalty").get("auto_param_L818_67", 0.5)
...
class BayesianPortfolioComposer:
    ...
    def calculate_coverage(
        ...
        if coverage >= get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L863_23", 0.9):
            penalty = get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("penalty", 0.0) # Refactored
        elif coverage >= get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L865_25", 0.7):
            penalty = (get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L866_23", 0.9) - coverage) * get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L866_41", 0.5)
        else:
            penalty = get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L868_22", 0.1) + (get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L868_29", 0.7) - coverage) * get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L868_47", 1.0)

        penalty = min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L870_22", 1.0), penalty)
    ...
    def compose_macro_portfolio(
        ...
        if not meso_analyses:
            return MacroLevelAnalysis(
                overall_posterior=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L885_34", 0.0),
                coverage_score=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L886_31", 0.0),
                coverage_penalty=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L887_33", 1.0),
                dispersion_score=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L888_33", 0.0),
                dispersion_penalty=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L889_35", 0.0),
                contradiction_count=0,
                contradiction_penalty=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L891_38", 0.0),
                total_penalty=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L892_30", 1.0),
                adjusted_score=get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L893_31", 0.0),
                cluster_scores={},
        ...
        dispersion_score = get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L911_27", 1.0) - dispersion_penalty
        ...
        total_penalty = min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L919_28", 1.0), total_penalty)

        # Adjusted score
        adjusted_score = raw_overall * (1 - total_penalty)
        adjusted_score = max(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L923_29", 0.0), min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L923_38", 1.0), adjusted_score))
    ...
    def _generate_recommendations(
        ...
        if coverage_penalty > get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L973_30", 0.1):
            recommendations.append(
                f"Improve question coverage (current: {coverage:.1%}). "
                "Address unanswered questions to reduce coverage penalty."
            )

        if dispersion_penalty > get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L979_32", 0.1):
            recommendations.append(
        ...
        if contradiction_penalty > get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L985_35", 0.05):
            recommendations.append(
    ...
    def export_to_csv(
        ...
        rows = [
            ...
            [
                ...
                'get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L1038_17", 0.0000)',
...
class MultiLevelBayesianOrchestrator:
    ...
    def _run_micro_level(
        ...
        for data in micro_data:
            ...
            raw_score = data.get('raw_score', get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L1141_46", 0.0))
            ...
            adjusted_score = max(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L1161_33", 0.0), min(get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("auto_param_L1161_42", 1.0), adjusted_score))
    ...
    def _run_meso_level(
        ...
        for cluster_id, question_ids in cluster_mapping.items():
            ...
            peer_penalty = get_parameter_loader().get("farfan_pipeline.analysis.bayesian_multilevel_system.BayesianPortfolioComposer.__init__").get("peer_penalty", 0.0) # Refactored
