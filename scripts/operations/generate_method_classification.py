...
SRC_ROOT = PROJECT_ROOT / "src" / "farfan_pipeline"
...
def scan_all_methods() -> set[str]:
    """Scan all Python files in src/farfan_pipeline to find all class.method combinations."""
    all_methods = set()
...
def generate_classification() -> dict[str, Any]:
    ...
    classification = {
        ...
        "FAKE_EXEC": {
            ...
            "snapshot": "src/farfan_pipeline/core/orchestrator/executors_snapshot/executors.py",
        ...
        "REAL_EXEC": {
            ...
            "file": "src/farfan_pipeline/core/orchestrator/executors_contract.py",
