...
class FunctionSignature:
    ...
    @calibrated_method("farfan_pipeline.utils.signature_validator.FunctionSignature.to_dict")
...
class SignatureRegistry:
    ...
    @calibrated_method("farfan_pipeline.utils.signature_validator.SignatureRegistry.compute_signature_hash")
    ...
    @calibrated_method("farfan_pipeline.utils.signature_validator.SignatureRegistry.register_function")
    ...
    @calibrated_method("farfan_pipeline.utils.signature_validator.SignatureRegistry._get_function_key")
    ...
    @calibrated_method("farfan_pipeline.utils.signature_validator.SignatureRegistry.get_signature")
    ...
    @calibrated_method("farfan_pipeline.utils.signature_validator.SignatureRegistry.has_signature_changed")
    ...
    @calibrated_method("farfan_pipeline.utils.signature_validator.SignatureRegistry.save")
    def save(self) -> None:
    ...
    @calibrated_method("farfan_pipeline.utils.signature_validator.SignatureRegistry.load")
    def load(self) -> None:
...
class SignatureAuditor:
    ...
    @calibrated_method("farfan_pipeline.utils.signature_validator.SignatureAuditor.audit_module")
    ...
    @calibrated_method("farfan_pipeline.utils.signature_validator.SignatureAuditor._extract_function_definitions")
    ...
    @calibrated_method("farfan_pipeline.utils.signature_validator.SignatureAuditor._extract_function_calls")
    ...
    @calibrated_method("farfan_pipeline.utils.signature_validator.SignatureAuditor.export_report")
