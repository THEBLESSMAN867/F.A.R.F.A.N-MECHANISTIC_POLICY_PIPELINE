...
# CategoriaCausal moved to farfan_pipeline.core.types to break architectural dependency
...
class AdvancedGraphNode:
    ...
    def _normalize_metadata(
        ...
        if "confidence" not in base_metadata or base_metadata["confidence"] is None:
            base_metadata["confidence"] = get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedGraphNode.__post_init__").get("auto_param_L174_42", 1.0)
    ...
    def _sanitize_confidence(value: Any) -> float:
        try:
            ...
            numeric = get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedGraphNode.__post_init__").get("numeric", 1.0) # Refactored
        return max(get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedGraphNode.__post_init__").get("auto_param_L192_19", 0.0), min(get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedGraphNode.__post_init__").get("auto_param_L192_28", 1.0), numeric))
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.AdvancedGraphNode.to_serializable_dict")
...
class TeoriaCambio:
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.TeoriaCambio.construir_grafo_causal")
    def construir_grafo_causal(self) -> nx.DiGraph:
        ...
        for origen in CategoriaCausal:
            for destino in self._MATRIZ_VALIDACION.get(origen, frozenset()):
                if origen != destino:
                    grafo.add_edge(origen.name, destino.name, peso=get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.TeoriaCambio.construir_grafo_causal").get("auto_param_L302_67", 1.0))
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.TeoriaCambio.construir_grafo_from_spc")
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.TeoriaCambio.validacion_completa")
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.TeoriaCambio._execute_generar_sugerencias_internas")
...
class AdvancedDAGValidator:
    ...
    def __init__(self, graph_type: GraphType = GraphType.CAUSAL_DAG) -> None:
        ...
        self.config: dict[str, Any] = {
            ...
            "confidence_level": get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.__init__").get("auto_param_L517_32", 0.95),
            "power_threshold": get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.__init__").get("auto_param_L518_31", 0.8),
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.add_edge")
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator._initialize_rng")
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator._generate_subgraph")
    ...
    def calculate_acyclicity_pvalue(
        ...
        p_value = acyclic_count / iterations if iterations > 0 else get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator._generate_subgraph").get("auto_param_L633_68", 1.0)
    ...
    @property
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.last_serialized_nodes")
    ...
    def _calculate_confidence_interval(
        ...
        if n == 0:
            return (get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.last_serialized_nodes").get("auto_param_L793_20", 0.0), get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.last_serialized_nodes").get("auto_param_L793_25", 1.0))
    ...
    @staticmethod
    def _calculate_statistical_power(s: int, n: int, alpha: float = get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.last_serialized_nodes").get("auto_param_L802_68", 0.05)) -> float:
        """Calcula el poder estadístico a posteriori."""
        if n == 0:
            return get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.last_serialized_nodes").get("auto_param_L805_19", 0.0)
        p = s / n
        effect_size = 2 * (np.arcsin(np.sqrt(p)) - np.arcsin(np.sqrt(get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.last_serialized_nodes").get("auto_param_L807_69", 0.5))))
        return stats.norm.sf(
            stats.norm.ppf(1 - alpha) - abs(effect_size) * np.sqrt(n / 2)
        )

    @staticmethod
    def _calculate_bayesian_posterior(likelihood: float, prior: float = get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.last_serialized_nodes").get("auto_param_L813_72", 0.5)) -> float:
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator._calculate_node_importance")
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.get_graph_stats")
    ...
    def _create_empty_result(
        ...
        return MonteCarloAdvancedResult(
            ...
            0,
            0,
            get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.get_graph_stats").get("auto_param_L864_12", 1.0),
            get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.get_graph_stats").get("auto_param_L865_12", 1.0),
            (get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.get_graph_stats").get("auto_param_L866_13", 0.0), get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.get_graph_stats").get("auto_param_L866_18", 1.0)),
            get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.get_graph_stats").get("auto_param_L867_12", 0.0),
            {},
            {},
            get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.get_graph_stats").get("auto_param_L870_12", 1.0),
            True,
            True,
            False,
            get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.AdvancedDAGValidator.get_graph_stats").get("auto_param_L874_12", 0.0),
            {},
            {},
        )
...
class IndustrialGradeValidator:
    ...
    def __init__(self) -> None:
        ...
        self.performance_benchmarks: dict[str, float] = {
            "engine_readiness": get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.IndustrialGradeValidator.__init__").get("auto_param_L892_32", 0.05),
            "graph_construction": get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.IndustrialGradeValidator.__init__").get("auto_param_L893_34", 0.1),
            "path_detection": get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.IndustrialGradeValidator.__init__").get("auto_param_L894_30", 0.2),
            "full_validation": get_parameter_loader().get("farfan_pipeline.analysis.teoria_cambio.IndustrialGradeValidator.__init__").get("auto_param_L895_31", 0.3),
        }

    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.IndustrialGradeValidator.execute_suite")
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.IndustrialGradeValidator.validate_engine_readiness")
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.IndustrialGradeValidator.validate_causal_categories")
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.IndustrialGradeValidator.validate_connection_matrix")
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.IndustrialGradeValidator.run_performance_benchmarks")
    ...
    @calibrated_method("farfan_pipeline.analysis.teoria_cambio.IndustrialGradeValidator._log_metric")
