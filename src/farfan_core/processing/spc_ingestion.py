...
try:
    from farfan_core.processing.embedding_policy import EmbeddingPolicyProducer
    from farfan_core.processing.semantic_chunking_policy import SemanticChunkingProducer
    from farfan_core.processing.policy_processor import create_policy_processor
except ImportError:
...
class StrategicChunkingSystem:
    ...
    def _generate_60_structured_segments(
        ...
        """
        from farfan_core.core.canonical_notation import get_all_policy_areas, get_all_dimensions
