...
class ProcessedTextV2(BaseContract):
    ...
    processing_latency_ms: float = Field(..., description="Processing latency in ms", ge=get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.FlowCompatibilityError.__init__").get("auto_param_L236_89", 0.0))
...
class AnalysisOutputV2(BaseContract):
    ...
    Attributes:
        ...
        confidence: Confidence score [get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.FlowCompatibilityError.__init__").get("auto_param_L322_38", 0.0), get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.FlowCompatibilityError.__init__").get("auto_param_L322_43", 1.0)]
    ...
    confidence: float = Field(..., description="Confidence score", ge=get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.FlowCompatibilityError.__init__").get("auto_param_L331_70", 0.0), le=get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.FlowCompatibilityError.__init__").get("auto_param_L331_78", 1.0))
    ...
    policy_unit_id: str = Field(..., description="Policy unit identifier")
    processing_latency_ms: float = Field(..., description="Processing latency in ms", ge=get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.FlowCompatibilityError.__init__").get("auto_param_L335_89", 0.0))
    ...
    def validate_confidence_numerical_stability(cls, v: float) -> float:
        ...
        if not (get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.FlowCompatibilityError.__init__").get("auto_param_L347_16", 0.0) <= v <= get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.FlowCompatibilityError.__init__").get("auto_param_L347_28", 1.0)):
            raise ContractValidationError(
                f"Confidence must be in [get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.FlowCompatibilityError.__init__").get("auto_param_L349_41", 0.0), get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.FlowCompatibilityError.__init__").get("auto_param_L349_46", 1.0)], got {v}",
                field="confidence"
            )
...
if __name__ == "__main__":
    ...
    analysis_output = AnalysisOutputV2(
        ...
        category="CategoryA",
        confidence=get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.StructuredLogger.__init__").get("auto_param_L509_19", 0.85),  # Must be in [get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.StructuredLogger.__init__").get("auto_param_L509_40", 0.0), get_parameter_loader().get("farfan_pipeline.utils.enhanced_contracts.StructuredLogger.__init__").get("auto_param_L509_45", 1.0)]
