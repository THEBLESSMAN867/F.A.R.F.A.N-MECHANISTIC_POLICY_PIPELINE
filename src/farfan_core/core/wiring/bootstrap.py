...
from farfan_core.config.paths import CONFIG_DIR, DATA_DIR
...
from farfan_core.core.orchestrator.factory import CoreModuleFactory
...
try:  # Optional dependency: calibration orchestrator
    from farfan_core.core.calibration.orchestrator import CalibrationOrchestrator as _CalibrationOrchestrator
    from farfan_core.core.calibration.config import DEFAULT_CALIBRATION_CONFIG as _DEFAULT_CALIBRATION_CONFIG
