...
* **Files:** `src/farfan_core/utils/method_config_loader.py`, consumers in
  `src/farfan_core/analysis/Analyzer_one.py` (e.g., `SemanticAnalyzer.__init__`),
...
* **Files:** `src/farfan_core/analysis/derek_beach.py` (`ConfigLoader` class around line 433)
...
* **Files:** `src/farfan_core/core/calibration/engine.py`, `core/calibration/layer_computers.py`,
...
* **Files:** `src/farfan_core/flux/cli.py`, `src/farfan_core/flux/configs.py`.
...
* **Files:** `src/farfan_core/core/orchestrator/executor_config.py` (Typer options + `SAAAAAA_EXEC_*`
  env overrides), `src/farfan_core/core/orchestrator/settings.py`, `src/farfan_core/core/orchestrator/core.py`,
...
* **Files:** `src/farfan_core/api/api_server.py` (FastAPI config class) and `src/farfan_core/core/orchestrator/settings.py`.
...
* **Files:** `src/farfan_core/processing/policy_processor.py` (`REQUIRE_CONTRADICTION_MODULE` env flag),
  `src/farfan_core/flux/phases.py` (policy unit IDs via env), `src/farfan_core/utils/determinism_helpers.py`
