...
from farfan_pipeline.processing.cpp_ingestion.models import CanonPolicyPackage, ChunkGraph, PolicyManifest, QualityMetrics, IntegrityIndex
from farfan_pipeline.core.phases.phase1_models import (
...
class Phase1SPCIngestionFullContract:
    ...
    def _construct_cpp_with_verification(self, ranked: List[SmartChunk]) -> CanonPolicyPackage:
        ...
        from farfan_pipeline.processing.cpp_ingestion.models import Chunk as LegacyChunk, ChunkResolution, TextSpan
