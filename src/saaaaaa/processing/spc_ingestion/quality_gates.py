...
class SPCQualityGates:
    ...
    @calibrated_method("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_input")
    ...
    def validate_quality_metrics(self, quality_metrics: Any) -> dict[str, Any]:
        ...
        if hasattr(quality_metrics, '__dict__'):
            # It's an object
            provenance_completeness = getattr(quality_metrics, 'provenance_completeness', get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L193_90", 0.0))
            structural_consistency = getattr(quality_metrics, 'structural_consistency', get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L194_88", 0.0))
            boundary_f1 = getattr(quality_metrics, 'boundary_f1', get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L195_66", 0.0))
            budget_consistency = getattr(quality_metrics, 'budget_consistency_score', get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L196_86", 0.0))
            temporal_robustness = getattr(quality_metrics, 'temporal_robustness', get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L197_82", 0.0))
            chunk_context_coverage = getattr(quality_metrics, 'chunk_context_coverage', get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L198_88", 0.0))
        else:
            # It's a dict
            provenance_completeness = quality_metrics.get('provenance_completeness', get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L201_85", 0.0))
            structural_consistency = quality_metrics.get('structural_consistency', get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L202_83", 0.0))
            boundary_f1 = quality_metrics.get('boundary_f1', get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L203_61", 0.0))
            budget_consistency = quality_metrics.get('budget_consistency_score', get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L204_81", 0.0))
            temporal_robustness = quality_metrics.get('temporal_robustness', get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L205_77", 0.0))
            chunk_context_coverage = quality_metrics.get('chunk_context_coverage', get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L206_83", 0.0))
        ...
        if chunk_context_coverage < get_parameter_loader().get("saaaaaa.processing.spc_ingestion.quality_gates.SPCQualityGates.validate_quality_metrics").get("auto_param_L275_36", 0.5):
            warnings.append(
