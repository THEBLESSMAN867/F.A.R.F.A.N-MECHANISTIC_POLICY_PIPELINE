...
CALIBRATIONS: Dict[str, Dict[str, Any]] = {
    ...
    "farfan_pipeline.analysis.derek_beach.CausalExtractor._calculate_language_specificity": {
        ...
        "weak_indicator_score": 0.5,
        "policy_specificity_boost": 0.15,
    ...
    "farfan_pipeline.analysis.derek_beach.CausalExtractor._assess_financial_consistency": {
        ...
        "consistent_min": 0.1,
        "consistent_max": 1.0,
        "consistent_score": 0.85,
        "slightly_inconsistent_max": 1.5,
    ...
    "farfan_pipeline.analysis.derek_beach.CausalExtractor._calculate_composite_likelihood": {
        ...
        "financial_consistency_weight": 0.10,
        "textual_proximity_weight": 0.10,
        "likelihood": 0.0,
        "triangulation_bonus_3": 1.15,
        "triangulation_bonus_2": 1.05,
        "triangulation_bonus_default": 1.0,
    ...
    "farfan_pipeline.analysis.derek_beach.CausalExtractor._calculate_confidence": {
        ...
        "strong_rigor_bonus": 0.15,
        "weak_rigor_penalty": 0.1,
        "max_confidence": 1.0,
        "min_confidence": 0.0,
    },
    ...
    "farfan_pipeline.analysis.derek_beach.FinancialAuditor._perform_counterfactual_budget_check": {
        ...
        "specific_allocation_bonus": 0.30,
...
def get_calibration(method_id: str) -> Dict[str, Any]:
    """
    Retrieves the calibration parameters for a given method_id.
    """
    return CALIBRATIONS.get(method_id, {})
